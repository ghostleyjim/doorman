...
void IDcheck(){
    if (digitalRead(Doorbit1) == LOW)
    {
        DoorID + 1;
    }
    if (digitalRead(Doorbit2) == LOW)
    {
        DoorID + 2;
    }
    if (digitalRead(Doorbit4) == LOW)
    {
        DoorID + 4;
    }
    if (digitalRead(Doorbit8) == LOW)
    {
        DoorID + 8;
    }
    if (digitalRead(Doorbit16) == LOW)
    {
        DoorID + 16;
    }
    if (digitalRead(Doorbit32) == LOW)
    {
        DoorID + 32;
    }
    if (digitalRead(Doorbit1) == HIGH && digitalRead(Doorbit2) == HIGH && digitalRead(Doorbit4) == HIGH) && digitalRead(Doorbit8) == HIGH && digitalRead(Doorbit16) == HIGH && digitalRead(Doorbit32) == HIGH)
    {
        DoorID = 1;
    }
}
